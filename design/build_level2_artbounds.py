...
PLATES = [
    ('pack-assist-v1.png',            4, 2, False),
    ('supervisor-head-v1.png',        4, 2, False),
    ('enemy-crawler-v1.png',          4, 2, False),
    ('enemy-spitter-v1.png',          4, 2, False),
    ('enemy-claw-v1.png',             4, 2, False),
    ('enemy-wasp-v1.png',             4, 2, False),
    ('furnace-platform-atlas-v1.png', 3, 2, False),
    ('furnace-prop-atlas-v1.png',     4, 2, False),
    ('casting-mold-v1.png',           1, 1, False),
    ('coolant-mist-v1.png',           4, 2, False),
    ('conveyor-belt-v1.png',          4, 1, True),
    ('lava-channel-v1.png',           4, 1, True),
    ('furnace-background-v1.png',     1, 1, True),
]
