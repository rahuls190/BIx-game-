...
Status: plan only. Do not build or replace Level 1 without a request. No game changes yet.
...
Art direction: keep the Level 1 industrial style, with brighter molten metal, deep shadows and clear platform edges.
...
These abilities and animations are proposals, not current Level 1 features.
